...
echo "# Looping starting loop with bam files in $STAR_BAM_DIR"
echo

for bam in "$STAR_BAM_DIR"/*Aligned.toTranscriptome.out.bam; do
...
echo "# All Salmon quant jobs finished."
